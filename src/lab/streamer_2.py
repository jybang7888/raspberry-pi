                ...
                if self.started :
                    ...
                    if len(lmList) != 0:
                        if (self.direction == "Left"):    
                            ...
                            if (lmList[25][1] <= lmList[31][1]) and (lmList[31][1] <= lmList[23][1]) and (self.angle_1 < 120) and (self.angle_2 < 140) and (self.stage != "Down"):
                                self.stage = "Down"
                                with conn.cursor() as cur :
                        ...
                        if (self.direction == "Right"):    
                            ...
                            if (lmList[26][1] >= lmList[32][1]) and (lmList[32][1] >= lmList[24][1]) and (self.angle_4 < 120) and (self.angle_5 < 140) and (self.stage != "Down"):
                                self.stage = "Down"
                                with conn.cursor() as cur :
                                    sql = "select * from squat"
                                    cur.execute(sql)
